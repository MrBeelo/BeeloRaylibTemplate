...
// include: /tmp/tmp0k4efdfa.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/web/BeeloRaylibTemplate.data';
      var REMOTE_PACKAGE_BASE = 'BeeloRaylibTemplate.data';
...
Module['FS_createPath']("/res", "assets", true, true);
Module['FS_createPath']("/res/assets", "shell", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/web/BeeloRaylibTemplate.data');

      };
      Module['addRunDependency']('datafile_bin/web/BeeloRaylibTemplate.data');
    ...
    loadPackage({"files": [{"filename": "/res/assets/shell/blank-shell.html", "start": 0, "end": 530}, {"filename": "/res/assets/shell/raylib-shell.html", "start": 530, "end": 14348}, {"filename": "/res/blob.png", "start": 14348, "end": 14702}], "remote_package_size": 14702});

  })();

// end include: /tmp/tmp0k4efdfa.js
// include: /tmp/tmpqjdrneh0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpqjdrneh0.js
// include: /tmp/tmp1rkax4mo.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1rkax4mo.js
...
function findWasmBinary() {
    return locateFile('BeeloRaylibTemplate.wasm');
}
...
var ASM_CONSTS = {
  98520: () => { if (document.fullscreenElement) return 1; },  
 98566: () => { return document.getElementById('canvas').width; },  
 98618: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98686: () => { document.exitFullscreen(); },  
 98713: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98786: () => { if (document.fullscreenElement) return 1; },  
 98832: () => { return document.getElementById('canvas').width; },  
 98884: () => { return screen.width; },  
 98909: () => { document.exitFullscreen(); },  
 98936: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99069: () => { return window.innerWidth; },  
 99095: () => { return window.innerHeight; },  
 99122: () => { if (document.fullscreenElement) return 1; },  
 99168: () => { return document.getElementById('canvas').width; },  
 99220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99288: () => { if (document.fullscreenElement) return 1; },  
 99334: () => { return document.getElementById('canvas').width; },  
 99386: () => { return screen.width; },  
 99411: () => { return window.innerWidth; },  
 99437: () => { return window.innerHeight; },  
 99464: () => { if (document.fullscreenElement) return 1; },  
 99510: () => { return document.getElementById('canvas').width; },  
 99562: () => { return screen.width; },  
 99587: () => { document.exitFullscreen(); },  
 99614: () => { if (document.fullscreenElement) return 1; },  
 99660: () => { return document.getElementById('canvas').width; },  
 99712: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99780: () => { document.exitFullscreen(); },  
 99807: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99865: () => { return screen.width; },  
 99890: () => { return screen.height; },  
 99916: () => { return window.screenX; },  
 99943: () => { return window.screenY; },  
 99970: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100023: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 100094: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 100151: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100407: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 100478: () => { if (document.fullscreenElement) return 1; },  
 100524: () => { return window.innerWidth; },  
 100550: () => { return window.innerHeight; },  
 100577: () => { if (document.pointerLockElement) return 1; }
};
